...
cli.add_typer(land_app, name="land")
...
def land_build(
    ...
    value: int = typer.Option(100, "--value", "-v"),
):
    """Build land"""
...
def land_sell(
    name: str = typer.Argument(..., help="Name"), money: float = typer.Option(..., help="Amount of money", min=0)
):
    """Sell land"""
...
cli.add_typer(people_app, name="people")


@people_app.command("add")
def people_add(
    fullname: str = typer.Argument(...), age: int = typer.Argument(...), home: str = typer.Option(None, "--home", "-h")
):
...
cli.add_typer(shops_app, name="shops")


@shops_app.command("build")
def shops_build(
    name: str = typer.Argument(..., help="Name"),
    land: str = typer.Argument(...),
...
cli.add_typer(home_app, name="home")
